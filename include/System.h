...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const string &str3DPtsFile, const string &str2DPtsFile, cv::Mat mARIm, const eSensor sensor, const bool bUseViewer = true);
